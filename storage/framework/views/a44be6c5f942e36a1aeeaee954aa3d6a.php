...
<?php $__env->startSection('title', 'Contact - Md Julfikar Hasan'); ?>
    ...
    <section class="contact-section">
        ...
        <div class="contact-content">
            <div class="contact-info">
                <h3>Get in Touch</h3>
                <p>📨 Email: <?php echo e($settings['email'] ?? 'mdjulfikerhasan191212@gmail.com'); ?></p>
                <p>📱 Mobile: <?php echo e($settings['phone'] ?? '+8801890770297'); ?></p>
                <p>🌍 Location: <?php echo e($settings['location'] ?? 'Bangladesh'); ?></p>
                <p>🎨 Portfolio: Behance – Md Julfikar Hasan</p>
                
                <div class="social-links">
                    <h4>Connect with me</h4>
                    <div class="social-grid">
                        <a href="<?php echo e($settings['behance_url'] ?? 'https://www.behance.net/mdjulfikerhasan'); ?>" target="_blank" class="social-link" title="Behance">
                        ...
                        <a href="<?php echo e($settings['linkedin_url'] ?? 'https://www.linkedin.com/in/md-julfikar-hasan-282249215'); ?>" target="_blank" class="social-link" title="LinkedIn">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                            </svg>
                        </a>
                        <a href="<?php echo e($settings['dribbble_url'] ?? 'https://dribbble.com/hasan1912'); ?>" target="_blank" class="social-link" title="Dribbble">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <a href="<?php echo e($settings['github_url'] ?? 'https://github.com/Julfiker-NpM'); ?>" target="_blank" class="social-link" title="GitHub">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
...
<?php $__env->startSection('footer'); ?>
    <footer>
        <div class="footer-content">
            ...
            <p class="copyright">&copy; <?php echo e(date('Y')); ?> Md Julfikar Hasan. All rights reserved.</p>
        </div>
    </footer>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\md-julfikar-hasan-v2\resources\views/pages/contact.blade.php ENDPATH**/ ?>